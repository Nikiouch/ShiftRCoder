<?php
  ...
  function textFileToBinFile($filename){
    ...
    $filename = "bin_texts/".$temp[0]."_bin.txt";
    $file = fopen($filename,'w+');
    fwrite($file, $result);
    fclose($file);
    return $filename;
  ...
  function binFileToTextFile($filename,$exp){
    ...
    $temp = explode("/",$temp[0]);
    $temp = explode("_",$temp[count($temp)-1]);
    $filename = "texts/".$temp[0]."_decoded".$exp.".txt";
    $file = fopen($filename,'w+');
    fwrite($file, $result);
    fclose($file);
    return $filename;
  ...
  function encodeBinFile($filename){
    ...
    $temp = explode("/",$temp[0]);
    $temp = explode("_",$temp[count($temp)-1]);
    $filename = "encode_texts/".$temp[0]."_encoded.txt";
    $file = fopen($filename,'w+');
    fwrite($file, $result);
    fclose($file);
    return $filename;
  ...
  function decodeBinFile($filename,$key){
    ...
    $temp = explode("/",$temp[0]);
    $temp = explode("_",$temp[count($temp)-1]);
    $filename = "decode_texts/".$temp[0]."_decoded.txt";
    $file = fopen($filename,'w+');
    fwrite($file, $result);
    fclose($file);
    return $filename;
